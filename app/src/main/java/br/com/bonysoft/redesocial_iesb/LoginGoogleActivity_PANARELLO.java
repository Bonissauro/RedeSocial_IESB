...
public class LoginGoogleActivity_PANARELLO extends AppCompatActivity {
    ...
    private void inicializarItens(){
        ...
        loginFacebookButton = (LoginButton) this.findViewById(R.id.facebook_login_button);
    ...
    IContatoRepositorio.OnGetContatoLogin tratamentoLogin = new IContatoRepositorio.OnGetContatoLogin() {
        ...
        public void onError(MensagemLogin message) {
            ...
            Toast.makeText(LoginGoogleActivity_PANARELLO.this,message.getMsg(),Toast.LENGTH_LONG);
        }
    };
    ...
    public void deleteAll(View v) {
        ...
        contatoRepositorio.deleteContatoById("", new IContatoRepositorio.OnDeleteContatoCallback() {
            ...
            public void onSuccess() {
                ...
                Toast.makeText(LoginGoogleActivity_PANARELLO.this,"Excluido todos os contatos",Toast.LENGTH_LONG).show();
            }
    ...
    public void esqueciMinhaSenha(View v) {
        Toast.makeText(LoginGoogleActivity_PANARELLO.this, "Esqueci minha senha nao implementado", Toast.LENGTH_LONG).show();

    }

    public void lembrarSenha(View v) {
        Toast.makeText(LoginGoogleActivity_PANARELLO.this, "Lembrar senha nao implementado", Toast.LENGTH_LONG).show();
    }
    ...
    public void logarComLoginSenha(View v) {
        ...
        dialog = ProgressDialog.show(LoginGoogleActivity_PANARELLO.this, "Aguarde", "Validando conta...", true);
        dialog.show();
        /*
        new Thread(){
            public void run(){
        ...
        */
        try {
            ...
            e.printStackTrace();
            Toast.makeText(LoginGoogleActivity_PANARELLO.this,"Erro ao logar",Toast.LENGTH_LONG);
        }
    ...
    public void naoTenhoConta(View v) {
        ...
        Toast.makeText(LoginGoogleActivity_PANARELLO.this, "Ainda nao tenho conta nao implementado", Toast.LENGTH_LONG).show();
    }
}
